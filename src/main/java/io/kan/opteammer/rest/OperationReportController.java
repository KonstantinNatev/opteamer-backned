...
import io.kan.opteammer.services.OperationReportService;
...
public class OperationReportController {
    ...
    public ResponseEntity<OperationReportDTO> getOperationReportById(
            @PathVariable(name = "teamMemberId") Long teamMemberId, @PathVariable(name = "operationId") Long operationId) {
    ...
    public ResponseEntity<OperationReportDTO> updateOperationReport(@PathVariable(name = "teamMemberId") Long teamMemberId,
